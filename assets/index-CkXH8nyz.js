(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[{id:1,name:`서연`,emoji:`👧`,color:`#6C5CE7`,colorLight:`rgba(108, 92, 231, 0.15)`,colorGlow:`rgba(108, 92, 231, 0.4)`,schedules:[{id:`s1-1`,type:`school`,name:`한빛초등학교`,icon:`🏫`,departureTime:`08:10`,arrivalTime:`08:30`,pickupTime:`13:40`,returnTime:`14:00`,days:[1,2,3,4,5],tasks:[`알림장 확인하기`,`숙제 챙기기`],supplies:[`교과서`,`필기도구`,`물통`],suppliesByDay:{2:[`체육복`],4:[`체육복`,`미술 준비물`]}},{id:`s1-2`,type:`academy`,name:`피아노 학원`,icon:`🎹`,departureTime:`15:00`,arrivalTime:`15:15`,pickupTime:`16:15`,returnTime:`16:30`,days:[1,3,5],tasks:[`피아노 연습곡 복습`],supplies:[`피아노 교재`,`연습 노트`],suppliesByDay:{}},{id:`s1-3`,type:`academy`,name:`영어 학원`,icon:`📚`,departureTime:`15:00`,arrivalTime:`15:20`,pickupTime:`16:30`,returnTime:`16:50`,days:[2,4],tasks:[`영어 단어 암기`,`워크북 풀기`],supplies:[`영어 교재`,`단어장`],suppliesByDay:{}}]},{id:2,name:`민준`,emoji:`👦`,color:`#00B894`,colorLight:`rgba(0, 184, 148, 0.15)`,colorGlow:`rgba(0, 184, 148, 0.4)`,schedules:[{id:`s2-1`,type:`school`,name:`한빛초등학교`,icon:`🏫`,departureTime:`08:10`,arrivalTime:`08:30`,pickupTime:`14:30`,returnTime:`14:50`,days:[1,2,3,4,5],tasks:[`알림장 확인하기`],supplies:[`교과서`,`필기도구`,`물통`],suppliesByDay:{1:[`리코더`],3:[`리코더`],5:[`체육복`]}},{id:`s2-2`,type:`academy`,name:`수학 학원`,icon:`🔢`,departureTime:`15:30`,arrivalTime:`15:45`,pickupTime:`17:00`,returnTime:`17:15`,days:[1,3,5],tasks:[`수학 숙제 확인`],supplies:[`수학 교재`,`노트`,`연습장`],suppliesByDay:{}},{id:`s2-3`,type:`academy`,name:`태권도`,icon:`🥋`,departureTime:`15:30`,arrivalTime:`15:45`,pickupTime:`16:45`,returnTime:`17:00`,days:[2,4],tasks:[`도복 세탁 확인`],supplies:[`도복`,`물통`,`수건`],suppliesByDay:{}}]},{id:3,name:`하은`,emoji:`👶`,color:`#E17055`,colorLight:`rgba(225, 112, 85, 0.15)`,colorGlow:`rgba(225, 112, 85, 0.4)`,schedules:[{id:`s3-1`,type:`school`,name:`무지개 유치원`,icon:`🌈`,departureTime:`09:00`,arrivalTime:`09:15`,pickupTime:`14:00`,returnTime:`14:15`,days:[1,2,3,4,5],tasks:[`가방 챙기기`,`알림장 확인`],supplies:[`가방`,`물통`,`낮잠이불(월)`],suppliesByDay:{1:[`낮잠이불`],5:[`낮잠이불 가져오기`]}},{id:`s3-2`,type:`academy`,name:`미술 학원`,icon:`🎨`,departureTime:`15:00`,arrivalTime:`15:10`,pickupTime:`16:00`,returnTime:`16:10`,days:[2,4],tasks:[`미술 작품 가져오기`],supplies:[`앞치마`,`미술 가방`],suppliesByDay:{}},{id:`s3-3`,type:`academy`,name:`발레 교실`,icon:`🩰`,departureTime:`15:00`,arrivalTime:`15:10`,pickupTime:`15:50`,returnTime:`16:00`,days:[1,3],tasks:[],supplies:[`발레복`,`발레슈즈`],suppliesByDay:{}}]}],t=`kids-schedule-data`;function n(){try{let e=localStorage.getItem(t);if(e)return JSON.parse(e)}catch(e){console.warn(`데이터 로드 실패, 기본값 사용:`,e)}return r(e),[...e]}function r(e){try{return localStorage.setItem(t,JSON.stringify(e)),!0}catch(e){return console.error(`데이터 저장 실패:`,e),!1}}function i(e){let t=n(),i=t.length>0?Math.max(...t.map(e=>e.id))+1:1,a=[{color:`#6C5CE7`,colorLight:`rgba(108, 92, 231, 0.15)`,colorGlow:`rgba(108, 92, 231, 0.4)`},{color:`#00B894`,colorLight:`rgba(0, 184, 148, 0.15)`,colorGlow:`rgba(0, 184, 148, 0.4)`},{color:`#E17055`,colorLight:`rgba(225, 112, 85, 0.15)`,colorGlow:`rgba(225, 112, 85, 0.4)`},{color:`#0984E3`,colorLight:`rgba(9, 132, 227, 0.15)`,colorGlow:`rgba(9, 132, 227, 0.4)`},{color:`#FDCB6E`,colorLight:`rgba(253, 203, 110, 0.15)`,colorGlow:`rgba(253, 203, 110, 0.4)`}],o=a[(i-1)%a.length],s={id:i,name:e.name,emoji:e.emoji||`👧`,...o,schedules:[]};return t.push(s),r(t),s}function a(e,t){let i=n(),a=i.findIndex(t=>t.id===e);return a===-1?null:(i[a]={...i[a],...t},r(i),i[a])}function o(e){let t=n().filter(t=>t.id!==e);return r(t),t}function s(e,t){let i=n(),a=i.find(t=>t.id===e);if(!a)return null;let o={id:`s${e}-${Date.now()}`,type:t.type||`academy`,name:t.name,icon:t.icon||`📚`,departureTime:t.departureTime,arrivalTime:t.arrivalTime,pickupTime:t.pickupTime,returnTime:t.returnTime,days:t.days||[],tasks:t.tasks||[],supplies:t.supplies||[],suppliesByDay:t.suppliesByDay||{}};return a.schedules.push(o),r(i),o}function c(e,t,i){let a=n(),o=a.find(t=>t.id===e);if(!o)return null;let s=o.schedules.findIndex(e=>e.id===t);return s===-1?null:(o.schedules[s]={...o.schedules[s],...i},r(a),o.schedules[s])}function l(e,t){let i=n(),a=i.find(t=>t.id===e);return a?(a.schedules=a.schedules.filter(e=>e.id!==t),r(i),a):null}function u(){return r(e),[...e]}var d=`kids-schedule-presets`,f=`kids-schedule-active-preset`;function p(){try{let e=localStorage.getItem(d);if(e)return JSON.parse(e)}catch(e){console.warn(`프리셋 로드 실패:`,e)}return{}}function m(e){localStorage.setItem(d,JSON.stringify(e))}function h(){return localStorage.getItem(f)||``}function g(e){localStorage.setItem(f,e)}function _(e){let t=p(),r=n();return t[e]=JSON.parse(JSON.stringify(r)),m(t),g(e),t}function ee(e){let t=p();if(!t[e])return null;let n=JSON.parse(JSON.stringify(t[e]));return r(n),g(e),n}function v(e){let t=p();return delete t[e],m(t),h()===e&&g(``),t}function y(){return{version:1,exportedAt:new Date().toISOString(),scheduleData:n(),presets:p(),activePreset:h(),theme:localStorage.getItem(`kids-schedule-theme`)||`dark`}}function te(e){if(!e||!e.scheduleData)throw Error(`올바른 백업 파일이 아닙니다.`);return r(e.scheduleData),e.presets&&localStorage.setItem(d,JSON.stringify(e.presets)),e.activePreset!==void 0&&g(e.activePreset),e.theme&&localStorage.setItem(`kids-schedule-theme`,e.theme),!0}function b(e){let[t,n]=e.split(`:`).map(Number),r=new Date;return new Date(r.getFullYear(),r.getMonth(),r.getDate(),t,n,0)}function x(e,t,n=new Date){let r=b(e),i=b(t)-r,a=n-r;return i<=0?0:Math.min(100,Math.max(0,a/i*100))}function S(e,t=new Date){let n=b(e)-t;if(n<=0)return`지남`;let r=Math.floor(n/(1e3*60*60)),i=Math.floor(n%(1e3*60*60)/(1e3*60));return r>0?`${r}시간 ${i}분 남음`:`${i}분 남음`}function C(e=new Date){return e.toLocaleTimeString(`ko-KR`,{hour:`2-digit`,minute:`2-digit`,second:`2-digit`,hour12:!1})}function ne(e=new Date){return`${e.getFullYear()}년 ${e.getMonth()+1}월 ${e.getDate()}일 (${[`일`,`월`,`화`,`수`,`목`,`금`,`토`][e.getDay()]})`}function w(e,t=new Date){let n=b(e.departureTime),r=b(e.arrivalTime),i=b(e.pickupTime);return t>=b(e.returnTime)?`completed`:t>=i?`returning`:t>=r?`in-class`:t>=n?`departing`:t>=new Date(n.getTime()-1800*1e3)?`upcoming`:`inactive`}function T(e){return{completed:`완료`,departing:`이동 중`,"in-class":`수업 중`,returning:`귀가 중`,upcoming:`곧 출발`,inactive:`예정`}[e]||e}function E(e){return{completed:`status-completed`,departing:`status-active`,"in-class":`status-active`,returning:`status-active`,upcoming:`status-upcoming`,inactive:`status-inactive`}[e]||``}function D(e){return`
    <header class="dashboard-header">
      <div class="header-content">
        ...
        <div class="header-right" style="display: flex; align-items: center; gap: 16px;">
          <div>
            <div class="header-date">${ne(e)}</div>
            <div class="header-time" id="header-time">${C(e)}</div>
          </div>
  ...
  `}function O(e){let t=document.getElementById(`header-time`);t&&(t.textContent=C(e))}function k(){let e=document.getElementById(`btn-toggle-theme`);e&&(e.addEventListener(`click`,()=>{Z()}),document.addEventListener(`theme-changed`,t=>{e.textContent=t.detail.isLight?`🌙`:`☀️`}))}function A(e,t=new Date){let n=t.getDay();return e.schedules.filter(e=>e.days.includes(n))}function j(e){return[...e].sort((e,t)=>b(e.departureTime)-b(t.departureTime))}function re(e,t=new Date){let n=t.getDay(),r=[...e.supplies],i=e.suppliesByDay?.[n]||[];return[...r,...i]}function ie(e,t=new Date){let n=j(A(e,t)),r=[],i=[],a=[];for(let e of n){let n=w(e,t);n===`completed`?r.push({...e,status:n}):[`departing`,`in-class`,`returning`].includes(n)?i.push({...e,status:n}):a.push({...e,status:n})}return{previous:r,current:i,upcoming:a,all:n}}function ae(e){if(e.length===0)return{start:`08:00`,end:`18:00`};let t=b(e[0].departureTime),n=b(e[0].returnTime);for(let r of e){let e=b(r.departureTime),i=b(r.returnTime);e<t&&(t=e),i>n&&(n=i)}t=new Date(t.getTime()-1800*1e3),n=new Date(n.getTime()+1800*1e3);let r=e=>String(e.getHours()).padStart(2,`0`),i=e=>String(e.getMinutes()).padStart(2,`0`);return{start:`${r(t)}:${i(t)}`,end:`${r(n)}:${i(n)}`}}function M(e,t,n){let r=w(e,n),i=T(r),a=E(r),o=re(e,n),s=[`departing`,`in-class`,`returning`].includes(r),c=r===`completed`,l=``,u=``;if(r===`departing`){let r=x(e.departureTime,e.arrivalTime,n),i=S(e.arrivalTime,n);l=`
      <div class="progress-bar-container">
        <div class="progress-bar" style="width: ${r}%; background: ${t}"></div>
      </div>
    `,u=`<span class="time-remaining">${i}</span>`}else if(r===`in-class`){let r=x(e.arrivalTime,e.pickupTime,n),i=S(e.pickupTime,n);l=`
      <div class="progress-bar-container">
        <div class="progress-bar" style="width: ${r}%; background: ${t}"></div>
      </div>
    `,u=`<span class="time-remaining">${i}</span>`}else if(r===`returning`){let r=x(e.pickupTime,e.returnTime,n),i=S(e.returnTime,n);l=`
      <div class="progress-bar-container">
        <div class="progress-bar" style="width: ${r}%; background: ${t}"></div>
      </div>
    `,u=`<span class="time-remaining">${i}</span>`}else r===`upcoming`&&(u=`<span class="time-remaining upcoming-remaining">${S(e.departureTime,n)}</span>`);let d=s&&o.length>0?`
  ...
  `}function oe(e,t,n){if(e.length===0)return`<div class="timeline-empty">오늘 일정이 없습니다 😊</div>`;let r=ae(e),i=b(r.start),a=b(r.end),o=a-i,s=Math.min(100,Math.max(0,(n-i)/o*100)),c=e.map(e=>{let r=(b(e.departureTime)-i)/o*100,a=(b(e.returnTime)-i)/o*100-r,s=w(e,n);return`
    ...
    `}).join(``),l=i.getHours(),u=a.getHours()+1,d=``;for(let e=l;e<=u;e++){let t=(b(`${String(e).padStart(2,`0`)}:00`)-i)/o*100;t>=0&&t<=100&&(d+=`<span class="timeline-marker" style="left: ${t}%">${e}시</span>`)}return`
  ...
  `}function N(e,t){let n=j(A(e,t)),{previous:r,current:i,upcoming:a}=ie(e,t),o=n.length>0,s=r.length>0?`
    <div class="schedule-section section-previous">
      <div class="section-label">
        <span class="section-dot completed"></span>
        이전 일정
      </div>
      ${r.map(n=>M(n,e.color,t)).join(``)}
    </div>
  `:``,c=i.length>0?`
  ...
  `).join(``),i=t?`
    <div class="admin-child-card" style="--child-color: ${t.color}">
      ...
      <div class="admin-schedules">
        ...
        ${t.schedules.length===0?`<p class="admin-empty">등록된 일정이 없습니다</p>`:t.schedules.map(e=>se(t.id,e)).join(``)}
      </div>
    </div>
  `:`<p class="admin-empty">아이를 추가해 주세요</p>`;return`
    ...
    <main class="admin-container">
      ...
      <div class="admin-toolbar">
        ...
        <button class="btn btn-ghost" id="btn-export-data">
          📥 데이터 내보내기
        </button>
        <button class="btn btn-ghost" id="btn-import-data">
          📤 데이터 불러오기
        </button>
  ...
  `}function se(e,t){if(U&&U.childId===e&&U.scheduleId===t.id)return ce(e,t);let n=t.days.map(e=>`<span class="day-tag active">${H[e]}</span>`).join(``),r=t.supplies.map(e=>`<span class="supply-tag">${e}</span>`).join(``),i=t.tasks.map(e=>`<span class="task-item">${e}</span>`).join(``);return`
  ...
  `}function q(e,t){let[n,r]=t.split(`:`).map(Number),i=Math.round(r/10)*10>=60?0:Math.round(r/10)*10;return`
    ...
    <div class="admin-schedule-edit" data-schedule-id="${t.id}">
      <div class="edit-form">
        ...
        <div class="form-row">
          <div class="form-group">
            <label>출발</label>
            ${q(`departureTime`,t.departureTime)}
          </div>
          <div class="form-group">
            <label>도착</label>
            ${q(`arrivalTime`,t.arrivalTime)}
          </div>
          <div class="form-group">
            <label>하원</label>
            ${q(`pickupTime`,t.pickupTime)}
          </div>
          <div class="form-group">
            <label>귀가</label>
            ${q(`returnTime`,t.returnTime)}
          </div>
        </div>
        <div class="form-row">
  ...
  `}var J=null;function le(e){J&&J.abort(),J=new AbortController;let{signal:t}=J,n=document.getElementById(`app`);n.addEventListener(`click`,t=>{let n=t.target.closest(`[data-action]`);if(!n)return;let r=n.dataset.action,i=n.dataset.childId?Number(n.dataset.childId):null,a=n.dataset.scheduleId||null;switch(r){case`delete-child`:confirm(`정말 이 아이를 삭제하시겠어요?`)&&(o(i),e());break;case`add-schedule`:{let t=s(i,{type:`academy`,name:`새 일정`,icon:`📚`,departureTime:`15:00`,arrivalTime:`15:15`,pickupTime:`16:00`,returnTime:`16:15`,days:[1,2,3,4,5],tasks:[],supplies:[]});t&&(U={childId:i,scheduleId:t.id},e());break}case`edit-schedule`:U={childId:i,scheduleId:a},e();break;case`cancel-edit`:U=null,e();break;case`save-schedule`:ue(i,a),U=null,e();break;case`delete-schedule`:confirm(`이 일정을 삭제하시겠어요?`)&&(l(i,a),e());break;case`switch-tab`:W=i,U=null,e();break;case`load-preset`:{let t=n.dataset.presetName;confirm(`'${t}' 일정을 불러오시겠습니까? 현재 일정은 덮어쓰여집니다.`)&&(ee(t),e());break}case`update-preset`:{let t=n.dataset.presetName;confirm(`현재 일정을 '${t}'에 덮어쓰시겠습니까?`)&&(_(t),e());break}case`delete-preset`:{let t=n.dataset.presetName;confirm(`'${t}' 일정을 삭제하시겠습니까?`)&&(v(t),e());break}}},{signal:t}),n.addEventListener(`click`,e=>{e.target.classList.contains(`day-btn`)&&e.target.classList.toggle(`active`)},{signal:t}),n.addEventListener(`change`,e=>{e.target.classList.contains(`admin-child-name-input`)&&a(Number(e.target.dataset.childId),{name:e.target.value}),e.target.classList.contains(`admin-emoji-select`)&&a(Number(e.target.dataset.childId),{emoji:e.target.value})},{signal:t});let r=[`departureTime`,`arrivalTime`,`pickupTime`,`returnTime`];n.addEventListener(`change`,e=>{let t=e.target;if(!t.classList.contains(`form-select`)||!t.dataset.timeField)return;let n=t.dataset.timeField,i=t.dataset.timePart,a=t.value,o=r.indexOf(n);if(o===-1)return;let s=t.closest(`.admin-schedule-edit`);if(s)for(let e=o+1;e<r.length;e++){let t=r[e],n=s.querySelector(`[data-time-field="${t}"][data-time-part="${i}"]`);n&&(n.value=a)}},{signal:t});let c=document.getElementById(`btn-back-dashboard`);c&&c.addEventListener(`click`,()=>L(`/`),{signal:t});let d=document.getElementById(`btn-toggle-theme-admin`);d&&(d.addEventListener(`click`,()=>{Z()},{signal:t}),document.addEventListener(`theme-changed`,e=>{d.textContent=e.detail.isLight?`🌙`:`☀️`},{signal:t}));let f=document.getElementById(`btn-add-child`);f&&f.addEventListener(`click`,()=>{i({name:`새 아이`,emoji:`🧒`}),e()},{signal:t});let p=document.getElementById(`btn-reset-data`);p&&p.addEventListener(`click`,()=>{confirm(`모든 데이터를 기본값으로 초기화하시겠어요?
현재 변경사항이 모두 사라집니다.`)&&(u(),e())},{signal:t});let m=document.getElementById(`btn-save-preset`);m&&m.addEventListener(`click`,()=>{let t=prompt(`저장할 일정 세트의 이름을 입력하세요
(예: 방학 스케줄, 새학기)`);t&&t.trim()&&(_(t.trim()),e())},{signal:t});let h=document.getElementById(`btn-export-data`);h&&h.addEventListener(`click`,()=>{let e=y(),t=JSON.stringify(e,null,2),n=new Blob([t],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`),a=new Date().toISOString().slice(0,10);i.href=r,i.download=`kids-schedule-backup-${a}.json`,document.body.appendChild(i),i.click(),document.body.removeChild(i),URL.revokeObjectURL(r),alert(`✅ 데이터가 성공적으로 내보내기 되었습니다!`)},{signal:t});let g=document.getElementById(`btn-import-data`),b=document.getElementById(`import-file-input`);g&&b&&(g.addEventListener(`click`,()=>{b.click()},{signal:t}),b.addEventListener(`change`,e=>{let t=e.target.files[0];if(!t)return;let n=new FileReader;n.onload=e=>{try{te(JSON.parse(e.target.result)),alert(`✅ 데이터가 성공적으로 불러오기 되었습니다!
화면을 새로고침합니다.`),location.reload()}catch(e){alert(`❌ 파일을 읽는 데 실패했습니다.
올바른 백업 JSON 파일인지 확인해 주세요.`),console.error(`Import error:`,e)}},n.readAsText(t),b.value=``},{signal:t}))}function ue(e,t){let n=document.querySelector(`.admin-schedule-edit[data-schedule-id="${t}"]`);if(!n)return;let r=e=>{let t=n.querySelector(`[data-field="${e}"]`);return t?t.value:``},i=[];n.querySelectorAll(`.day-btn.active`).forEach(e=>{i.push(Number(e.dataset.day))});let a=r(`supplies`),o=r(`tasks`),s=e=>{let t=n.querySelector(`[data-time-field="${e}"][data-time-part="hour"]`),r=n.querySelector(`[data-time-field="${e}"][data-time-part="min"]`);return!t||!r?`00:00`:`${String(t.value).padStart(2,`0`)}:${String(r.value).padStart(2,`0`)}`};c(e,t,{type:r(`type`),icon:r(`icon`),name:r(`name`),departureTime:s(`departureTime`),arrivalTime:s(`arrivalTime`),pickupTime:s(`pickupTime`),returnTime:s(`returnTime`),days:i.sort(),supplies:a?a.split(`,`).map(e=>e.trim()).filter(Boolean):[],tasks:o?o.split(`,`).map(e=>e.trim()).filter(Boolean):[]})}var Y=document.getElementById(`app`),X=null;function Z(){let e=document.documentElement.classList.toggle(`light-theme`);localStorage.setItem(`kids-schedule-theme`,e?`light`:`dark`),document.dispatchEvent(new CustomEvent(`theme-changed`,{detail:{isLight:e}}))}function Q(){localStorage.getItem(`kids-schedule-theme`)===`light`&&document.documentElement.classList.add(`light-theme`)}function de(){let e=new Date,t=n(),r=t.map(t=>N(t,e)).join(``);Y.innerHTML=`
    ${D(e)}
  ...
  `,document.getElementById(`btn-go-admin`)?.addEventListener(`click`,()=>{L(`/admin`)}),k(),pe(t)}function fe(){$();let e=()=>{Y.innerHTML=G(),le(e)};e()}function pe(e){$(),X=setInterval(()=>{let e=new Date,t=n();O(e),t.forEach(t=>{let n=document.querySelector(`[data-child-schedules="${t.id}"]`),r=document.querySelector(`[data-child-timeline="${t.id}"]`);if(n){let i=document.createElement(`div`);i.innerHTML=N(t,e);let a=i.querySelector(`[data-child-schedules="${t.id}"]`),o=i.querySelector(`[data-child-timeline="${t.id}"]`);a&&n.innerHTML!==a.innerHTML&&(n.innerHTML=a.innerHTML),r&&o&&r.innerHTML!==o.innerHTML&&(r.innerHTML=o.innerHTML)}})},1e3)}function $(){X&&=(clearInterval(X),null)}I(`/`,de),I(`/admin`,fe),Q(),z();